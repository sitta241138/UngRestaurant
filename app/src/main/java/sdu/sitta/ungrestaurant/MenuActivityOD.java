...
public class MenuActivityOD extends AppCompatActivity {
    ...
    private void createListView() {
        ...
        String[] strC_Pic = objDrink.readALLMenuTable(3);
        String[] strC_Price = objDrink.readALLMenuTable(3);
        ...
        MyAdapter objMyAdapter = new MyAdapter(MenuActivityOD.this, strC_Name,o3,strC_Price);
